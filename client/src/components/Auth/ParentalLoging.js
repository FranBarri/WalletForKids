  ...
  return (
    <div>
      ...
      <div className="w-full max-w-xs text-center mx-auto">
        ...
        <Link to='/register/niñxs' className="inline-block margin-bottom:30px  align-baseline font-bold text-sm text-blue-500 hover:text-blue-800" >
